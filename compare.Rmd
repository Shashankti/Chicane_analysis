...
tabl <- "  # Comapring the output baits
| Runs                  | Baits(input)  | Baits(Output) | Bait-to-bait | 
|---------------        |:-------------:|--------------:|-------------:|
| Raw data              | 33931         | 32955         | 41.56% |
| Raw data(wo_overlap)  | 22093         | 21647         | 48.51% |
| Binned                | 33931         | 33060         | 40.64% |
| Binned(wo_overlap)    | 22093         | 21700         | 47.68% |
"
cat(tabl) # output the table in a format good for HTML/PDF/docx conversion
```
```{r table1, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
tabl1 <- "  # Comapring the output fragments which are not classified as baits
| Runs                  | Frags(input)  | Frags(Output) | Nonbait frags(input) | Nonbait frags(output) |
|----------------------:|:-------------:|--------------:| --------------------:|----------------------:|
| Raw data              | 7435356       | 7373301       | 7401425              | 7352301               | 
| Raw data(wo_overlap)  | 7423518       | 7384342       | 7401425              | 7352144               |
| Binned                | 680094        | 551739        | 658001               | 519619                |
| Binned(wo_overlap)    | 668256        | 540627        | 646163               | 519423                |
"
...
tabl2 <- "  # Comapring significant interactions
| Runs                  | Total         | Cis           | Trans  |
|---------------        |:-------------:|--------------:|-------:|
| Raw data              | 0.094%        | 17.52%        | 82.47% |
| Raw data(wo_overlap)  | 0.097%        | 12.22%        | 87.74% |
| Binned                | 0.132%        | 16.56%        | 83.43% |
| Binned(wo_overlap)    | 0.134%        | 12.61%        | 87.38% |
"
