...
#malat1 neat1
ggplot(ibed[is.na(ibed$distance)|!ibed$bait_name=="MALAT1"|!ibed$baitname=="NEAT1"],aes(count,log(q.value,base=10)))+
  geom_point(color="#69b3a2",size=0.5,alpha=0.3)+
  theme_cowplot()+
  ggtitle("Count distribution of trans interaction without MALAT1 and NEAT1")
```
